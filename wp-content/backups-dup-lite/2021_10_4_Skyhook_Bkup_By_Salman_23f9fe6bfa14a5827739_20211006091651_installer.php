...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '2021_10_4_Skyhook_Bkup_By_Salman_23f9fe6bfa14a5827739_20211006091651_archive.zip';
	const ARCHIVE_SIZE		 = '104008286';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '23f9fe6-06091651';
    const SECONDARY_PACKAGE_HASH = 'b742ab6-06091651';
	const VERSION			 = '1.4.3';
