		...
		<div class="row">
			<div class="col-md-12 solution-banner ">
				...
				<p>
					...
					through phonebook-thick reports to see if they need to log more experience. With skyhook.is they see it in
					a simple manner and know exactly how much additional experience they need to log, and when they need
					to log it. To make sure that technicians always find time to log experience, skyhook.is works on all types of
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6  category-image">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sol-categories-imge.jpg">
			...
			<div class="col-md-6  category-section">
				<div class="logoss">
					...
					<P>Skyhook for Technicians</P>
				</div>
				<h1>Categgories Status Dashboard</1h>

					<p>When a technician logs into skyhook.is he sees the dashboard. The dashboard gives him an overview of the whole system. There the technician can see his categories status, his statistic and most recent experience entries. The categories status is a visual representation of the logbook status. In the picture blow the category status is on top of the screenshot. Here Adam Is logging experience on category B1, group 1 (the group number is inside the blue cogwheel). His status is
