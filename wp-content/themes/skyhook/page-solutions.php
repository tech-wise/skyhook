    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-12 solution-banner ">
                ...
                <p>
                    Skyhook.is makes maintaining an experience logbook simple and easy. Technicians do not need to read
                    through phonebook-thick reports to see if they need to log more experience. With skyhook.is they see
                    it in
                    a simple manner and know exactly how much additional experience they need to log, and when they need
                    to log it. To make sure that technicians always find time to log experience, skyhook.is works on all
                    types of
                    devices, screen sizes and platforms. We also offer mobile apps for iOS and Android.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6  category-section">
                ...
                <h1>Categgories Status Dashboard</1h>
                    <p>When a technician logs into skyhook.is he sees the dashboard. The dashboard gives him an overview
                        ...
                        status. In the picture blow the category status is on top of the screenshot. Here Adam Is
...
<section class="sol-section-4">
    ...
    <div class="container sol-reports">
        <div class="row ">
            <div class="col-md-7  reports-section logos">
                <h5>
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/small-logo.png">Skyhook Expereince
                </h5>
                <h1>Experience Reports</1h>
                    ...
                    <!-- <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/why-text-image.png"> -->
                    <div class="col-md-10 reports-section-technicians">
...
<section class="sol-section-5">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-11  experience-report">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sol-recent-experience-repot.png">
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-6  profile-image">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sol-profile-image.jpg">
...
<section class="sol-section-10">
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-12 text-center features-image">
                <h1>Features</h1>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/features-image.jpg">
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-4 category-status text-justify">
            ...
            <div class="col-md-4  experince-report text-justify ">
            ...
            <div class="col-md-4   experince-logbook  text-justify">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6  sol-reports-section">
                ...
                <h1>Reports</1h>
                    ...
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/images/solution-reports-background-image.png">
            </div>
